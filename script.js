                ...
                if (file) {
                    ...
                    if (file.type === 'application/pdf') {
                        ...
                        logoPreview.innerHTML = `
                            ...
                            <p style="margin-top: 0.5rem; font-size: 0.9rem; color: #02734E;">✓ PDF uploaded successfully</p>
                        `;
                    } else {
                        // Image preview
                        ...
                        reader.onload = function(e) {
                            logoPreview.innerHTML = `
                                ...
                                <p style="margin-top: 0.5rem; font-size: 0.9rem; color: #02734E;">✓ Logo uploaded successfully</p>
                            `;
                        };
